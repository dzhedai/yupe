    ...
    if ($.fn.inputmask == undefined) {
        ...
        $.fn.inputmask = function (fn, options) {
            ...
            function checkVal(input, buffer, clearInvalid, skipRadixHandling) {
                ...
                var lastMatch = -1, checkPosition = -1, np, maskL = getMaskLength(), ivl = inputValue.length,
            ...
            function mask(el) {
                ...
                var buffer = _buffer.slice(), undoBuffer = el._valueGet(), skipKeyPressEvent = false, ignorable = false,
                    lastPosition = -1, firstMaskPos = seekNext(buffer, -1),
                    lastMaskPos = seekPrevious(buffer, getMaskLength()), isRTL = false;
                ...
                $input.bind("mouseenter.inputmask", function () {
                    ...
                    setTimeout(function () {
                        ...
                        if (selectedCaret.begin == selectedCaret.end) {
                            ...
                            if (isRTL) caret(input, clickPosition > lastPosition && (isValid(clickPosition, buffer[clickPosition], buffer, true) !== false || !isMask(clickPosition)) ? clickPosition : lastPosition); else
                ...
                function patchValueProperty(npt) {
                    ...
                    if (valueProperty && valueProperty.get) {
                        ...
                        if ($.fn.val.inputmaskpatch != true) {
                            ...
                            $.extend($.fn.val, {inputmaskpatch: true});
                        }
                    }
                }
